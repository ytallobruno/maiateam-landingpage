                ...
                <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="text-green-400 font-medium">Educador Físico</span>
                        </motion.div>
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-300 text-lg leading-relaxed">
                                Meu objetivo com esse protocolo é ofertar um treino individualizado e direcionado para
                                seus objetivos com um <strong className="text-green-400">valor acessível</strong>, pois
                                sei que muitas pessoas ainda não podem investir em uma consultoria completa.
                            </p>
                        </div>
