            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white leading-tight">
                        Veja como é a <span className="text-green-400">planilha completa</span>
                    </h2>
                    <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                        Assista ao vídeo abaixo para visualizar um exemplo da planilha que você receberá
                    </p>
                </motion.div>
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                        ...
                        >
                            <h3 className="text-2xl md:text-3xl font-bold mb-6 text-white">O que está incluído:</h3>
                            <ul className="space-y-4">
                                <li className="flex items-center gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                                    <span className="text-gray-300">Exercícios detalhados com vídeos</span>
                                </li>
                                <li className="flex items-center gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                                    <span className="text-gray-300">Métodos avançados explicados</span>
                                </li>
                                <li className="flex items-center gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                                    <span className="text-gray-300">Diretrizes completas de treinamento</span>
                                </li>
                                <li className="flex items-center gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                                    <span className="text-gray-300">Alongamentos e mobilidade</span>
                                </li>
                                <li className="flex items-center gap-3">
                                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />
                        ...
                        >
                            ...
                            <p className="text-center text-sm text-gray-400 mt-4">
                                {!isPlaying ? "Clique para assistir ao vídeo" : "Vídeo da planilha completa"}
                            </p>
                        </motion.div>
                    </div>
                </motion.div>
